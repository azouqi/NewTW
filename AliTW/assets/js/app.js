...
//End slide show for tablet size
//Range Slider
...
function changeOrder(){
	...
	if($WindowsSize<991){
		...
		$SliderContainer.insertAfter("#pageFive");
	...
	//remove the class in middle size page to show the text in center
	$("#pageSeven div").removeClass("col-sm-pull-6");
}
};
